  ...
  return (
    <>
      ...
      <nav className="navbar-lg">
        <span className="logo"> PS </span>
        <ul className="links">
                <Link to='/'  className='nav-link tooltip'> <li> <AiOutlineHome size={20}/><span className="tooltiptext para">Home</span> </li></Link>
                <Link to='/projects' className='nav-link tooltip' > <li> <GrProjects size={20}/> <span className="tooltiptext para">Projects</span> </li> </Link>
                <Link to='/skills' className='nav-link tooltip' > <li> <BsTools size={20}/><span className="tooltiptext para">Tools</span> </li> </Link>
                <Link to='/about' className='nav-link tooltip' > <li> <BsPerson size={20}/> <span className="tooltiptext para">About</span></li>  </Link>
                <Link to='/contact' className='nav-link tooltip' > <li> <AiOutlineMail size={20}/> <span className="tooltiptext para">Contact</span> </li></Link>
        </ul>
        <div className="social-links"> 
            <span> < AiFillGithub size={20}/> </span>
            <span>  <BsFacebook size={20}/> </span>
